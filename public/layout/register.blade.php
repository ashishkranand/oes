    ...
    <div class="right">
        <nav>
            <ul>
                ...
                <li>Contact us</li>
                <li onclick="location.href='./login.blade.php';">Login</li>
                <li>about</li>
            </ul>
           </nav>
    </div>
   ...
   <div class="main">
    <div class="login">
      ...
      <form action="registeruser.php" method="POST">
        ...
        <input type="text" name="confirmpassword" id="" class="input"><br>
        <a href="./login.blade.php" style="font-weight: bolder;font-size: medium; color: black;margin-left: 3%;">Already register, Login</a><br>
